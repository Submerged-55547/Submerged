...
async def main():
    ...
    def mast():
        move.forward_for(11, "cm", 650, 650)
        move.right_motor_left_for(650, 70)
        
        move.right_motor_left_for(50, 90)
        move.forward_for(22,"cm",650,650)
        print(MotionSensor.get_yaw())

        move.left_motor_left_for(100,95)
        
        front_arm.run_to_position(320, direction="counterclockwise", speed=200)
        move.forward_for(11,"cm",650,650)
        print("A",MotionSensor.get_yaw())
        move.left_motor_right_for(50,95)
        ...
        move.forward_for(9.5,"cm",100,100)
        print("C",MotionSensor.get_yaw())
        #breakpoint(button.LEFT)
        run(sleep_ms(200))
        move.backward_for(14,"cm",40,40)
    def back_home():
        front_arm.run_to_position(100,speed=650)
        front_arm.run_to_position(112,speed=20)
