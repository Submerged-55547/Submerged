...
async def main():
    ...
    def artificial_habitat():
        ...
        back_arm.run_to_position(165, direction="clockwise", speed=50)
    ...
    def unknown_creature():
        ...
        move.backward_for(16, "cm", 650, 650) 
        move.left_motor_right_for(300, -90)
        print(MotionSensor.get_yaw())
        move.backward_for(34, "cm", 650, 650)
        # Move this to start
        front_arm.run_to_position(129,direction="clockwise", speed=650)
        move.forward_to([WHITE],-650,-650)
        #move.backward_for(83.5, "cm", 650, 650)
        move.left_motor_left_for(200,-45)
        back_arm.run_to_position(190, speed=200)
        move.backward_for(2, "cm", 650, 650)
        move.left_motor_right_for(650,-90)
        move.left_motor_left_for(100,-90)
        move.backward_for(62, "cm",650,650)
